...
EXCEPTION WHEN others THEN NULL; END $$;
--> statement-breakpoint
ALTER TABLE "trips" ADD COLUMN IF NOT EXISTS "trip_meta" jsonb;--> statement-breakpoint
ALTER TABLE "trips" ADD COLUMN IF NOT EXISTS "deleted_at" timestamp;--> statement-breakpoint
DO $$ BEGIN
...
EXCEPTION WHEN duplicate_object THEN NULL; END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "popular_places_city_idx" ON "popular_places" USING btree ("city");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "popular_places_city_place_idx" ON "popular_places" USING btree ("city","place_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "trip_invites_token_idx" ON "trip_invites" USING btree ("token");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "trip_invites_trip_idx" ON "trip_invites" USING btree ("trip_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "trip_members_trip_user_idx" ON "trip_members" USING btree ("trip_id","user_id");
