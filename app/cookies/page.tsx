...
export const metadata: Metadata = {
  title: 'Cookie Policy',
  description: 'Marenn Cookie Policy — what cookies we use, why we use them, and how you can manage your preferences in compliance with Thailand PDPA B.E. 2562.',
}
    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      <article className="policy-page">
        ...
        <div className="policy-box">
          <p>
            This Cookie Policy explains what cookies and similar technologies Marenn uses, why we use them, and how you can control them. It supplements our <a href="/privacy">Privacy Policy</a> and complies with the <strong>Thailand Personal Data Protection Act B.E. 2562 (PDPA)</strong>.
          </p>
        </div>
        ...
        <p>
          Marenn currently uses only privacy-friendly, server-side analytics without third-party tracking scripts. If third-party analytics (e.g. Google Analytics) are introduced in future, this policy will be updated and your consent will be re-requested before activation.
        </p>

        <h3>2.4 Marketing Cookies (Not Used)</h3>
        <p>
          Marenn does <strong>not</strong> currently use any marketing, retargeting, or advertising cookies. We do not share your browsing behaviour with any advertising networks.
        </p>

        {/* 3. Third-party technologies */}
        <h2>3. Third-Party Technologies</h2>
        <p>The following third-party services may set their own cookies or access data when you use Marenn:</p>
        <ul>
          <li>
          ...
          <li>
            <strong>Google Fonts (fonts.googleapis.com)</strong> — Loads typefaces used in the app. Google may log the request. No personal data from Marenn is shared. See Google&apos;s policy for details.
          </li>
          <li>
        ...
        <p>
          When you first visit Marenn, a cookie notice will inform you of the cookies in use. Strictly necessary cookies are activated without consent; optional categories require your opt-in.
        </p>
        ...
        <p>
          To remove Marenn&apos;s local storage data (your offline trip plan), open browser Developer Tools (F12), go to <em>Application → Local Storage → [your Marenn domain]</em>, and delete the <code>tripzync_onboarding</code> key, or clear all site data.
        </p>
        ...
        <div className="policy-box">
          <p>
            ...
            <strong>Email:</strong> <a href="mailto:privacy@marenn.com">privacy@marenn.com</a><br />
