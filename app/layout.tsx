...
export const metadata: Metadata = {
  ...
  title: { default: 'Maren — Every Trip, Carefully Planned', template: '%s | Maren' },
  description: 'Maren is your personal AI-powered travel planner. Build custom itineraries, track expenses, and keep your hotel loyalty program in sync — all in one calm, considered place.',
  ...
  openGraph: {
    ...
    url: BASE_URL,
    siteName: 'Maren',
    title: 'Maren — Every Trip, Carefully Planned',
