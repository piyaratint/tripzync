...
export const metadata: Metadata = {
  ...
  description: 'Marenn Privacy Policy — how we collect, use, and protect your personal data in compliance with Thailand PDPA B.E. 2562 and international standards.',
}
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      <article className="policy-page">
        ...
        <div className="policy-box">
          <p>
            <strong>Marenn</strong><br />
            Contact: <a href="mailto:privacy@marenn.com">privacy@marenn.com</a><br />
        ...
        <p>
          Marenn is hosted on Vercel infrastructure, which may process data outside Thailand (including the United States and European Union). We ensure such transfers comply with PDPA Chapter VI and, where applicable, the EU Standard Contractual Clauses. Your data is subject to appropriate safeguards at all times.
        </p>
        ...
        <p>
          To exercise any right, contact us at <a href="mailto:privacy@marenn.com">privacy@marenn.com</a>. We will respond within 30 days. We may need to verify your identity before processing your request.
        </p>
        ...
        <p>
          Marenn is not directed at individuals under the age of 20 (the age of majority in Thailand). We do not knowingly collect personal data from minors. If you believe a minor has provided us with data, please contact us and we will delete it promptly.
        </p>
        ...
        <p>
          We may update this Privacy Policy from time to time. When we make material changes, we will notify you via email (if you have an account) and update the &ldquo;Effective&rdquo; date at the top. Continued use of Marenn after the effective date constitutes acceptance of the updated policy.
        </p>
